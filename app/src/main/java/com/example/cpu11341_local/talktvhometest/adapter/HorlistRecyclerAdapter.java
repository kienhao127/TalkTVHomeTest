...
public class HorlistRecyclerAdapter extends RecyclerView.Adapter<HorlistRecyclerAdapter.RecyclerViewHolder> {
    private ArrayList<DocHorizon> arrHorList = new ArrayList<DocHorizon>();

    public HorlistRecyclerAdapter(){
    }

    public HorlistRecyclerAdapter(ArrayList<DocHorizon> arrHorList){
        this.arrHorList = arrHorList;
    }

    @Override
    public HorlistRecyclerAdapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.horlist_item_layout,parent,false);

        HorlistRecyclerAdapter.RecyclerViewHolder recyclerViewHolder = new HorlistRecyclerAdapter.RecyclerViewHolder(view);
        return recyclerViewHolder;
    }

    @Override
    public void onBindViewHolder(HorlistRecyclerAdapter.RecyclerViewHolder holder, int position) {
